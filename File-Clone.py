...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mABDUL NUR RIFAT
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+880140200959
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mTechnical Rifat
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://youtube.com/channel/UCtroS3zfJuXHIiztYrFtysg")
		exit()
...
def setting():
	...
	if fast in ['y','Y']:
		...
		os.system("xdg-open https://youtube.com/channel/UCtroS3zfJuXHIiztYrFtysg")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [RIFAT] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [RIFAT-CP] %s|%s        '%(b,idf,pw))
